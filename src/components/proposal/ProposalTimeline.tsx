const phases = [
  ...
  },
  {
    ...
    activities: [
      ...
      { name: 'Edge Functions - monitoramento de tickets', hours: 32 },
      { name: 'Edge Functions - categorizacao IA', hours: 26 },
      { name: 'Edge Functions - follow-up via Teams', hours: 36 },
      { name: 'Edge Functions - escalacao inteligente', hours: 26 },
      { name: 'Edge Functions - analytics e metricas', hours: 20 },
      ...
      { name: 'Integracao OpenAI GPT-4', hours: 26 },
