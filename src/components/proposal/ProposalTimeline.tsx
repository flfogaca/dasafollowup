const phases = [
  {
    ...
    hours: 104,
    activities: [
      { name: 'Levantamento e analise de requisitos', hours: 20 },
      { name: 'Definicao da arquitetura tecnica', hours: 14 },
      { name: 'Design de APIs e contratos de integracao', hours: 20 },
      ...
      { name: 'Reunioes e alinhamentos com stakeholders', hours: 20 },
    ],
    deliverables: [
      'Documento de arquitetura tecnica',
      'Especificacao de APIs e integracao',
  ...
  },
  {
    ...
    hours: 416,
    activities: [
      { name: 'Schema e modelagem de banco de dados', hours: 16 },
      { name: 'Edge Functions - monitoramento de tickets', hours: 40 },
      { name: 'Edge Functions - categorizacao IA', hours: 36 },
      { name: 'Edge Functions - follow-up via Teams', hours: 42 },
      { name: 'Edge Functions - escalacao inteligente', hours: 36 },
      { name: 'Edge Functions - analytics e metricas', hours: 26 },
      { name: 'Integracao ServiceNow TSM', hours: 52 },
      { name: 'Integracao Microsoft Teams (Graph API)', hours: 40 },
      { name: 'Integracao Active Directory', hours: 26 },
      { name: 'Integracao OpenAI GPT-4', hours: 32 },
      { name: 'APIs de consulta e gestao', hours: 32 },
      { name: 'Autenticacao OAuth2 e RBAC', hours: 20 },
  ...
  },
  {
    ...
    hours: 156,
    activities: [
      { name: 'Testes de integracao E2E', hours: 40 },
      { name: 'Testes de carga e performance', hours: 24 },
      { name: 'Testes de seguranca e LGPD', hours: 24 },
      { name: 'Bug fixes e otimizacoes', hours: 36 },
      { name: 'Documentacao tecnica', hours: 20 },
      { name: 'Reunioes de validacao', hours: 12 },
    ],
    deliverables: [
